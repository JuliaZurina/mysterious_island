...
func _load_text():
	queue_text("Hey kiddo, are you lost?") 
	queue_text("Listen, the monsters like demobats here are pretty aggressive,") 
	queue_text("also on the shores, giant crabs are disturbing our fishermen")
	queue_text("Help us clear and save our land") 
